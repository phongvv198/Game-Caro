...
description: Senior .NET reviewer — chọn agent này khi muốn review chặn (blocking) một diff/file. Direct, chia severity Block/Suggest/Nit, kèm code snippet và top-3 priorities.
